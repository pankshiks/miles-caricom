...
namespace Drupal\color_pickr\Utility;

use Drupal\Component\Utility\Html as DrupalHtml;

/**
 * Provides utility functions for working with HTML in Drupal.
 *
 * Extends the Drupal\Component\Utility\Html class to provide additional
 * functionality or overrides as needed.
 */
